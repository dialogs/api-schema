...
GPBEnumDescriptor *AuthorizationMethod_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    static const char *valueNames =
        "AuthorizationMethodNothing\000Authorization"
        "MethodUsername\000AuthorizationMethodPhone\000"
        "AuthorizationMethodEmail\000AuthorizationMe"
        "thodCertificate\000AuthorizationMethodOauth"
        "\000";
    static const int32_t values[] = {
        AuthorizationMethod_AuthorizationMethodNothing,
        AuthorizationMethod_AuthorizationMethodUsername,
        AuthorizationMethod_AuthorizationMethodPhone,
        AuthorizationMethod_AuthorizationMethodEmail,
        AuthorizationMethod_AuthorizationMethodCertificate,
        AuthorizationMethod_AuthorizationMethodOauth,
    };
...
BOOL AuthorizationMethod_IsValidValue(int32_t value__) {
  switch (value__) {
    case AuthorizationMethod_AuthorizationMethodNothing:
    case AuthorizationMethod_AuthorizationMethodUsername:
    case AuthorizationMethod_AuthorizationMethodPhone:
    case AuthorizationMethod_AuthorizationMethodEmail:
    case AuthorizationMethod_AuthorizationMethodCertificate:
    case AuthorizationMethod_AuthorizationMethodOauth:
      return YES;
    default:
      return NO;
  }
