...
@implementation RequestRegisterAvroraPushToken

@dynamic token;

typedef struct RequestRegisterAvroraPushToken__storage_ {
  uint32_t _has_storage_[1];
  NSString *token;
} RequestRegisterAvroraPushToken__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "token",
        .dataTypeSpecific.clazz = Nil,
        .number = RequestRegisterAvroraPushToken_FieldNumber_Token,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(RequestRegisterAvroraPushToken__storage_, token),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[RequestRegisterAvroraPushToken class]
                                     rootClass:[PushRoot class]
                                          file:PushRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(RequestRegisterAvroraPushToken__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
...
@implementation RequestUnregisterAvroraPushToken

@dynamic token;

typedef struct RequestUnregisterAvroraPushToken__storage_ {
  uint32_t _has_storage_[1];
  NSString *token;
} RequestUnregisterAvroraPushToken__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "token",
        .dataTypeSpecific.clazz = Nil,
        .number = RequestUnregisterAvroraPushToken_FieldNumber_Token,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(RequestUnregisterAvroraPushToken__storage_, token),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[RequestUnregisterAvroraPushToken class]
                                     rootClass:[PushRoot class]
                                          file:PushRoot_FileDescriptor()
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(RequestUnregisterAvroraPushToken__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
